...
void LArPIDVarCoreHalo() 
{
  ...
  TH1D* hist_bg_corehalo = new TH1D("hist_bg_corehalo","Background",50,0,0.025);
  TH1D* hist_signal_corehalo = new TH1D("hist_signal_corehalo","Signal",50,0,0.025);
 ...
 hist_signal_corehalo->Scale(1/hist_signal_corehalo->Integral());
 hist_bg_corehalo->Scale(1/hist_bg_corehalo->Integral());
