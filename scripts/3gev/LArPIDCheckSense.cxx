...
{
  // Fill vectors 
  std::vector<std::vector<TVector3>> trackcon = FillTracksSense("/data/t2k/phumhh/lbne/ntuple_3gev_muon.root");
  std::vector<std::vector<TVector3>> spacepointcon = FillSpacePointsSense("/data/t2k/phumhh/lbne/ntuple_3gev_muon.root");
  std::vector<TMatrixD> evcon = FillEigenVectorsSense("/data/t2k/phumhh/lbne/ntuple_3gev_muon.root");
  Int_t tracknum= 0;
