...
public:
  ...
  std::vector<double>   AnglePATrueTrack;
  std::vector<std::vector<TVector3>> PCAHitsSpacePoints;
  std::vector<double>   StdDevDistFromFitLine;
  std::vector<double>   AvgedEdxAmpStart;
  std::vector<double>   AvgedEdxAmpEnd;
  std::vector<double>   AvgedEdxAmpLongRatio;
  std::vector<double>   AvgedEdxAmpEndRatio;
  std::vector<double>   AvgedEdxAmpEndRatio10;
  std::vector<double>   AvgedEdxAmpStartDist;
  std::vector<double>   AvgedEdxAmpEndDist;
  std::vector<double>   AvgedEdxAmpLongRatioDist;
  std::vector<double>   AvgedEdxAmpEndRatioDist;
  std::vector<double>   AvgedEdxAreaStart;
  std::vector<double>   AvgedEdxAreaEnd;
  std::vector<double>   AvgedEdxAreaLongRatio;
  std::vector<double>   AvgedEdxAreaEndRatio;
  std::vector<double>   AvgedEdxAreaEndRatio10;
  std::vector<double>   AvgedEdxAreaStartDist;
  std::vector<double>   AvgedEdxAreaEndDist;
  std::vector<double>   AvgedEdxAreaLongRatioDist;
  std::vector<double>   AvgedEdxAreaEndRatioDist;
