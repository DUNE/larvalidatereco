...

{
  ...
  Int_t nentries_fill;
  if(hist_bg_grad->GetEntries()>hist_signal_grad->GetEntries()) { nentries_fill =  hist_signal_grad->GetEntries(); }
  else { nentries_fill = hist_bg_grad->GetEntries(); }
  ...
  hist_bg_grad->Scale(1/hist_bg_grad->Integral());

  hist_bg_grad->SetStats(0);
  hist_signal_grad->SetStats(0);

  hist_signal_grad->SetStats(0);
  hist_proton_grad->SetStats(0);
  hist_piplus_grad->SetStats(0);
